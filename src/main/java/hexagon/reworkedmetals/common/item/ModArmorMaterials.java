...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    BRONZE("bronze", 15, new int[] {2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0f, 0.0f, 0.0f, Ingredient.of(ReworkedMetalsItems.BRONZE_INGOT.get()), false),
    IRON("iron", 20, new int[] {2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 1.0f, 0.0f, 0.0f, Ingredient.of(Items.IRON_INGOT), false),
    STEEL("steel", 33, new int[] {3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0f, 0.0f, 0.0f, Ingredient.of(ReworkedMetalsItems.STEEL_INGOT.get()), false),
