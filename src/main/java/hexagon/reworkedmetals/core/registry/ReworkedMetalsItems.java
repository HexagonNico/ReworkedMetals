...
public class ReworkedMetalsItems {
    ...
    public static final RegistryObject<Item> SMELTERY = REGISTER.register("smeltery", () -> new BlockItem(ReworkedMetalsBlocks.SMELTERY.get(), new Item.Properties().tab(ItemGroup.TAB_DECORATIONS)));
    public static final RegistryObject<Item> FURNACE = OVERRIDES.register("furnace", () -> new BlockItem(ReworkedMetalsBlocks.FURNACE.get(), new Item.Properties().tab(ItemGroup.TAB_DECORATIONS)));
