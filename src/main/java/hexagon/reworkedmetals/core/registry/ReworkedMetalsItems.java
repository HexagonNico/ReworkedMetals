...
public class ReworkedMetalsItems {
    ...
    public static final RegistryObject<Item> RUBY_ORE = REGISTER.register("ruby_ore", () -> new BlockItem(ReworkedMetalsBlocks.RUBY_ORE.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    public static final RegistryObject<Item> DEEPSLATE_RUBY_ORE = REGISTER.register("deepslate_ruby_ore", () -> new BlockItem(ReworkedMetalsBlocks.DEEPSLATE_RUBY_ORE.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RUBY_BLOCK = REGISTER.register("ruby_block", () -> new BlockItem(ReworkedMetalsBlocks.RUBY_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> GOLD_RUBY_HOE = REGISTER.register("gold_ruby_hoe", () -> new HoeItem(ModToolTiers.GOLD_RUBY, -3, -0.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
