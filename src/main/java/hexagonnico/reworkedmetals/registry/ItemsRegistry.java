...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> RAW_SILVER = REGISTER.register("raw_silver", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> SILVER_INGOT = REGISTER.register("silver_ingot", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    ...
    public static final RegistryObject<Item> SILVER_PICKAXE = REGISTER.register("silver_pickaxe", () -> new PickaxeItem(ModToolTiers.SILVER, 1, -2.8f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_SWORD = REGISTER.register("silver_sword", () -> new SwordItem(ModToolTiers.SILVER, 3, -2.4f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> SILVER_AXE = REGISTER.register("silver_axe", () -> new AxeItem(ModToolTiers.SILVER, 7.0f, -3.2f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_SHOVEL = REGISTER.register("silver_shovel", () -> new ShovelItem(ModToolTiers.SILVER, 1.5f, -3.0f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_HOE = REGISTER.register("silver_hoe", () -> new HoeItem(ModToolTiers.SILVER, -0, -2.5f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_RUBY_PICKAXE = REGISTER.register("silver_ruby_pickaxe", () -> new PickaxeItem(ModToolTiers.SILVER_RUBY, 1, -2.8f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_RUBY_SWORD = REGISTER.register("silver_ruby_sword", () -> new SwordItem(ModToolTiers.SILVER_RUBY, 3, -2.4f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> SILVER_RUBY_AXE = REGISTER.register("silver_ruby_axe", () -> new AxeItem(ModToolTiers.SILVER_RUBY, 5.0f, -3.1f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_RUBY_SHOVEL = REGISTER.register("silver_ruby_shovel", () -> new ShovelItem(ModToolTiers.SILVER_RUBY, 1.5f, -3.0f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_RUBY_HOE = REGISTER.register("silver_ruby_hoe", () -> new HoeItem(ModToolTiers.SILVER_RUBY, -2, -2.0f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_DIAMOND_PICKAXE = REGISTER.register("silver_diamond_pickaxe", () -> new PickaxeItem(ModToolTiers.SILVER_DIAMOND, 1, -2.8f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_DIAMOND_SWORD = REGISTER.register("silver_diamond_sword", () -> new SwordItem(ModToolTiers.SILVER_DIAMOND, 3, -2.4f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> SILVER_DIAMOND_AXE = REGISTER.register("silver_diamond_axe", () -> new AxeItem(ModToolTiers.SILVER_DIAMOND, 7.0f, -3.2f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_DIAMOND_SHOVEL = REGISTER.register("silver_diamond_shovel", () -> new ShovelItem(ModToolTiers.SILVER_DIAMOND, 1.5f, -3.0f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    public static final RegistryObject<Item> SILVER_DIAMOND_HOE = REGISTER.register("silver_diamond_hoe", () -> new HoeItem(ModToolTiers.SILVER_DIAMOND, -0, -2.5f, new Item.Properties().tab(ItemGroup.TAB_TOOLS)));
    ...
    public static final RegistryObject<Item> SILVER_ORE = REGISTER.register("silver_ore", () -> new BlockItem(BlocksRegistry.SILVER_ORE.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RAW_SILVER_BLOCK = REGISTER.register("raw_silver_block", () -> new BlockItem(BlocksRegistry.RAW_SILVER_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> SILVER_BLOCK = REGISTER.register("silver_block", () -> new BlockItem(BlocksRegistry.SILVER_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
