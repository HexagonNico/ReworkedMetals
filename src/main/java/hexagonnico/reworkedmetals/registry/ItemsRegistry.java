...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> RAW_ALUMINUM = REGISTER.register("raw_aluminum", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> ALUMINUM_INGOT = REGISTER.register("aluminum_ingot", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    ...
    public static final RegistryObject<Item> RAW_NICKEL = REGISTER.register("raw_nickel", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> NICKEL_INGOT = REGISTER.register("nickel_ingot", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> INVAR_INGOT = REGISTER.register("invar_ingot", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    ...
    public static final RegistryObject<Item> ALUMINUM_ORE = REGISTER.register("aluminum_ore", () -> new BlockItem(BlocksRegistry.ALUMINUM_ORE.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    public static final RegistryObject<Item> NICKEL_ORE = REGISTER.register("nickel_ore", () -> new BlockItem(BlocksRegistry.NICKEL_ORE.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RAW_ALUMINUM_BLOCK = REGISTER.register("raw_aluminum_block", () -> new BlockItem(BlocksRegistry.RAW_ALUMINUM_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RAW_NICKEL_BLOCK = REGISTER.register("raw_nickel_block", () -> new BlockItem(BlocksRegistry.RAW_NICKEL_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> ALUMINUM_BLOCK = REGISTER.register("aluminum_block", () -> new BlockItem(BlocksRegistry.ALUMINUM_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> NICKEL_BLOCK = REGISTER.register("nickel_block", () -> new BlockItem(BlocksRegistry.NICKEL_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    public static final RegistryObject<Item> INVAR_BLOCK = REGISTER.register("invar_block", () -> new BlockItem(BlocksRegistry.INVAR_BLOCK.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
