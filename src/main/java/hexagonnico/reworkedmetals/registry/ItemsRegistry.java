...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> RAW_COPPER = REGISTER.register("raw_copper", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
    public static final RegistryObject<Item> COPPER_INGOT = REGISTER.register("copper_ingot", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
    ...
    public static final RegistryObject<Item> RAW_IRON = REGISTER.register("raw_iron", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
    public static final RegistryObject<Item> RAW_GOLD = REGISTER.register("raw_gold", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
    ...
    public static final RegistryObject<Item> COPPER_ORE = REGISTER.register("copper_ore", () -> new BlockItem(BlocksRegistry.COPPER_ORE.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RAW_COPPER_BLOCK = REGISTER.register("raw_copper_block", () -> new BlockItem(BlocksRegistry.RAW_COPPER_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> RAW_IRON_BLOCK = REGISTER.register("raw_iron_block", () -> new BlockItem(BlocksRegistry.RAW_IRON_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    public static final RegistryObject<Item> RAW_GOLD_BLOCK = REGISTER.register("raw_gold_block", () -> new BlockItem(BlocksRegistry.RAW_GOLD_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> COPPER_BLOCK = REGISTER.register("copper_block", () -> new BlockItem(BlocksRegistry.COPPER_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
