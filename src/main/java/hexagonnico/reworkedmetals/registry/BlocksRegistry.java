...
public class BlocksRegistry {
    ...
    public static final RegistryObject<Block> ALUMINUM_ORE = REGISTER.register("aluminum_ore", () -> new ModOreBlock(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(3.0f, 3.0f).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
    public static final RegistryObject<Block> SILVER_ORE = REGISTER.register("silver_ore", () -> new ModOreBlock(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(3.0f, 3.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    public static final RegistryObject<Block> NICKEL_ORE = REGISTER.register("nickel_ore", () -> new ModOreBlock(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(3.0f, 3.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    ...
    public static final RegistryObject<Block> RAW_ALUMINUM_BLOCK = REGISTER.register("raw_aluminum_block", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(5.0f, 6.0f).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
    ...
    public static final RegistryObject<Block> RAW_SILVER_BLOCK = REGISTER.register("raw_silver_block", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0f, 6.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    public static final RegistryObject<Block> SILVER_BLOCK = REGISTER.register("silver_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0f, 6.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    public static final RegistryObject<Block> RAW_NICKEL_BLOCK = REGISTER.register("raw_nickel_block", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0f, 6.0f).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    ...
    public static final RegistryObject<Block> ALUMINUM_BLOCK = REGISTER.register("aluminum_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
    ...
    public static final RegistryObject<Block> NICKEL_BLOCK = REGISTER.register("nickel_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
    public static final RegistryObject<Block> INVAR_BLOCK = REGISTER.register("invar_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).harvestLevel(2)));
