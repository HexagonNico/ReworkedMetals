...
public class ReworkedSmeltingRecipe implements Recipe<ReworkedFurnaceBlockEntity> {
     ...
     */
    public ReworkedSmeltingRecipe(ResourceLocation id, FriendlyByteBuf buffer) {
        this.id = id;
    ...
    private static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<ReworkedSmeltingRecipe> {
        ...
        @Override
        public ReworkedSmeltingRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            return new ReworkedSmeltingRecipe(recipeId, buffer);
        }
    
        @Override
        public void toNetwork(FriendlyByteBuf buffer, ReworkedSmeltingRecipe recipe) {
