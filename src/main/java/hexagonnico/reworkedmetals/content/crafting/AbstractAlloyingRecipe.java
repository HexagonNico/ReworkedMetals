 ...
 * @author Nico
 */
public abstract class AbstractAlloyingRecipe implements Recipe<AbstractAlloyingFurnaceBlockEntity> {
	 ...
	 */
	public AbstractAlloyingRecipe(ResourceLocation id, JsonObject recipeJson) {
		this.id = id;
	 ...
	 */
	public AbstractAlloyingRecipe(ResourceLocation id, FriendlyByteBuf buffer) {
		this.id = id;
	...
	protected static abstract class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<AbstractAlloyingRecipe> {

		@Override
		public void toNetwork(FriendlyByteBuf buffer, AbstractAlloyingRecipe recipe) {
