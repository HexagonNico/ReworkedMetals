...
/**
 * Result slot for {@link AlloyingFurnaceContainerMenu}.
 * @author Nico
 */
public class AlloyingFurnaceResultSlot extends Slot {
	 ...
	 */
	public AlloyingFurnaceResultSlot(Container container, Player player, int index, int x, int y) {
	...
	protected void checkTakeAchievements(ItemStack itemStack) {
		...
		if(this.player instanceof ServerPlayer serverPlayer && this.container instanceof AbstractAlloyingFurnaceBlockEntity blockEntity) {
