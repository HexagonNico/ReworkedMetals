 ...
 * @author Nico
 */
public class AlloyingFurnaceContainerMenu extends AbstractContainerMenu {

	private final AbstractAlloyingFurnaceBlockEntity blockEntity;
	 ...
	 */
	public AlloyingFurnaceContainerMenu(int id, Inventory playerInventory, AbstractAlloyingFurnaceBlockEntity blockEntity, ContainerData containerData) {
		...
		this.addSlot(new AlloyingFurnaceFuelSlot(blockEntity, 4, 47, 71));
		this.addSlot(new AlloyingFurnaceResultSlot(blockEntity, playerInventory.player, 5, 118, 26));
	 ...
	 */
	public AlloyingFurnaceContainerMenu(int id, Inventory playerInventory, FriendlyByteBuf buffer) {
		this(id, playerInventory, (AbstractAlloyingFurnaceBlockEntity) playerInventory.player.level.getBlockEntity(buffer.readBlockPos()), new SimpleContainerData(4));
	}
