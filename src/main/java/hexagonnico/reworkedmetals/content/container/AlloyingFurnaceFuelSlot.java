...
/**
 * Fuel slot for {@link AlloyingFurnaceContainerMenu}.
 * @author Nico
 */
public class AlloyingFurnaceFuelSlot extends Slot {
	 ...
	 */
	public AlloyingFurnaceFuelSlot(Container container, int index, int x, int y) {
