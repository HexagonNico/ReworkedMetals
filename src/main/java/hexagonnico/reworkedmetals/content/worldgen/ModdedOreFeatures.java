...
public class ModdedOreFeatures {
	...
	public static final PlacedFeature TIN_ORE = PlacementUtils.register("tin_ore", TIN_CONFIGURATION.placed(ModdedOres.trianglePlacement(4, 12, 48, 112)));
	public static final PlacedFeature TIN_ORE_LOWER = PlacementUtils.register("tin_ore_lower", TIN_CONFIGURATION.placed(ModdedOres.trianglePlacement(4, 8, -16, 0)));
	...
	public static final PlacedFeature ALUMINUM_ORE = PlacementUtils.register("aluminum_ore", ALUMINUM_CONFIGURATION.placed(ModdedOres.trianglePlacement(5, 8, 88)));
	public static final PlacedFeature ALUMINUM_ORE_LOWER = PlacementUtils.register("aluminum_ore_lower", ALUMINUM_BURIED_CONFIGURATION.placed(ModdedOres.trianglePlacement(5, -48, -16)));
	...
	public static final PlacedFeature SILVER_ORE = PlacementUtils.register("silver_ore", SILVER_CONFIGURATION.placed(ModdedOres.trianglePlacement(2, 6, -64, 32)));
	public static final PlacedFeature SILVER_ORE_MOUNTAINS = PlacementUtils.register("silver_ore_mountains", SILVER_BURIED_CONFIGURATION.placed(ModdedOres.trianglePlacement(4, 112, 144)));
	...
	public static final PlacedFeature NICKEL_ORE = PlacementUtils.register("nickel_ore", NICKEL_CONFIGURATION.placed(ModdedOres.trianglePlacement(2, 6, -64, -16)));
