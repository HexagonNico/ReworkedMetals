 ...
 * @author Nico
 */
public class AlloyingFurnaceScreen extends AbstractContainerScreen<AlloyingFurnaceContainerMenu> {
	 ...
	 */
	public AlloyingFurnaceScreen(AlloyingFurnaceContainerMenu container, Inventory playerInventory, Component title) {
